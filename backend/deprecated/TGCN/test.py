"""
This script was provided by (https://github.com/dxli94/WLASL). It's a helper class used to 
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load(os.path.join(root, 
                            'code/TGCN/archive/{}/{}'.format(trained_on, checkpoint)))
